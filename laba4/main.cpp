...
class IDONTCARE2:public IDONTCAREBASE, private IDONTCARE{
	...
	IDONTCARE2(string idk1,string idk2,string idk3):IDONTCARE(idk1,idk2),IDONTCAREBASE(idk3){
		idc1= 11;
	cout << "constr IDONTCARE2 \n";
	}
	~IDONTCARE2(){
	cout << "destr IDONTCARE2 \n";
	}
};
...
void sum(IDONTCARE2 f,IDONTCARE2 fe){
cout << f.idc1 + fe.idc1 << endl;
}
void sum(IDONTCARE2* f,IDONTCARE2* fe){
cout << f->idc1 + fe->idc1 << endl;
}
